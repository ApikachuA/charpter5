package fastcampus.part.charpter5
...
import fastcampus.part.charpter5.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun operatorClicked(view: View){
        ...
        if(secondNumberText.isNotEmpty()){
            Toast.makeText(this, "1개의 연사잔에 대해서만 연산이 가능합니다.", Toast.LENGTH_SHORT).show()
            return
        }
